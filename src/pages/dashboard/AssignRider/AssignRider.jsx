...
const AssignRider = () => {
  ...
  const { data: riders = [], refetch: parcelRefetch } = useQuery({
    queryKey: selectedParcel
      ? ["riders", selectedParcel.senderDistrict, "available"]
      : ["riders", "idle"], // fallback key
    enabled: !!selectedParcel,
    queryFn: async () => {
      if (!selectedParcel) return []; // safety fallback
      const res = await axiosSecure.get(
